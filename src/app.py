...
activities = {
    ...
    "Soccer Practice": {
        "description": "Team training for soccer skills and game strategy",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 22,
        "participants": ["luca@mergington.edu", "maria@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Improve basketball fundamentals and play friendly matches",
    ...
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["tyler@mergington.edu", "sophia@mergington.edu"]
    },
    "Math Olympiad": {
